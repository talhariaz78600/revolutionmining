...
const Profile = () => {
  ...
  return (
    <div>
      ...
      >
        {/* <link
        href="//www.revolutionmining.io/cdn/shop/t/1/assets/customer-dashboard.css?v=24958605696784891171680536548"
        rel="stylesheet"
        type="text/css"
        media="all"
      /> */}
        <div className="dis-flex dashboard">
          <nav className="nav-account">
            <ul>
              ...
              <li>
                <Link href="/account?view=invoices">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                    width="16.13"
              ...
              <li>
                <Link href="/collections/asics">
                  ...
                  >
                    ...
                    <g
                      id="Raggruppa_1400"
                      data-name="Raggruppa 1400"
                      transform="translate(0 0)"
                    >
                      <g
                        id="Raggruppa_1399"
                        data-name="Raggruppa 1399"
                        transform="translate(0 0)"
                        clipPath="url(#clip-path)"
                      >
                        <path
          ...
          <div className="customer account">
            <div id="order-status">
              ...
              <div className="orders-list">
                <table role="table" className="order-history small-hide">
                  ...
                  <thead role="rowgroup">
                    <tr role="row">
                      ...
                      <th id="ColumnFacility" scope="col" role="columnheader">
                        Facility
                      </th>
                      <th id="ColumnMachine" scope="col" role="columnheader">
                        Machine
                      </th>
                      ...
                      <th
                        id="ColumnHostingPrice"
                        scope="col"
                        role="columnheader"
                      >
                        <center>Hashrate</center>
                      </th>
                      <th id="ColumnTotal" scope="col" role="columnheader">
                        <center>Monthly Hosting Fee</center>
                      </th>
                      <th id="ColumnMiningDate" scope="col" role="columnheader">
                        <center>Target Online Date</center>
                      </th>
                    </tr>
                  </thead>
                  <tbody role="rowgroup">
                ...
                <div className="order-history medium-hide large-up-hide"></div>
              </div>
            </div>
          </div>
        </div>
