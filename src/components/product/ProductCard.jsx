            ...
            <div id="shopify-section-template--14480007495725__product-grid"
                ...
                <div id="ProductGridContainer">
                    <div className="collection page-width">
                        ...
                        <img src="//www.revolutionmining.io/cdn/shop/t/1/assets/Elephants_Mesh_Grey.svg?v=143355747152055222861644598858"
                                    ...
                                    <div className="card-information">
                                        <div className="card-information__wrapper">
                                            ...
                                            <div className="product-form__input product-form__input--dropdown">
                                                <label className="form__label" for="Option-7748136468525-0">
                                                    Hosted in
                                                </label>
                                                <ul className="option"><li className="active-option" data-host="USA"></li></ul>
                                                <div className="select">
                                                    <select id="Option-7748136468525-0" className="select__select" name="options[Hosted in]" form="product-form-7748136468525"><option value="USA" selected="selected">
                                                        USA
                                                    </option></select>
                                            ...
                                            <div className="card-detail">
                                                <p className="py-5" data-mce-fragment="1"><strong>Includes 3
                                                    Machines</strong>
                                                </p>
                                                <p>• Condition: New</p>
                                                <p>• 200 TH | 3500 Watts </p>
                                                <p>• Hosting Fee: $588/month </p>
