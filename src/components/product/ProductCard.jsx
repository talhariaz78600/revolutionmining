...
const products = [
    {
        ...
        location: "USA",
        price: 15000,
        imageSrc: "/images/bundle.webp",
        details: [
            "Includes 3 Machines",
            "Condition: New",
            "200 TH | 3500 Watts",
            "Hosting Fee: $588/month",
            "Revolution Texas Facility",
            "Online Date: June 2024"
        ]
    },
    {
        id: 2,
        name: "Antminer S19 110TH Bundle",
        location: "Canada",
        price: 12000,
        imageSrc: "/images/bundle.webp",
        details: [
            ...
            "110 TH | 3000 Watts",
            "Hosting Fee: $450/month",
            "Revolution Canada Facility",
            "Online Date: May 2024"
        ]
    },
    {
        id: 3,
        name: "Whatsminer M30S 100TH Bundle",
        location: "USA",
        price: 13000,
        imageSrc: "/images/bundle.webp",
        details: [
            ...
            "Condition: New",
            "100 TH | 3300 Watts",
            "Hosting Fee: $500/month",
            "Revolution USA Facility",
            "Online Date: July 2024"
        ]
    },
    {
        id: 4,
        name: "AvalonMiner 1246 90TH Bundle",
        location: "Germany",
        price: 10000,
        imageSrc: "/images/bundle.webp",
        details: [
            ...
            "Condition: New",
            "90 TH | 3200 Watts",
            "Hosting Fee: $400/month",
            "Revolution Germany Facility",
            "Online Date: August 2024"
        ]
    },
    {
        id: 5,
            ...
            <div id="shopify-section-template--14480007495725__product-grid"
                ...
                <div id="ProductGridContainer">
                    <div className="collection page-width">
                        ...
                        <img src="//www.revolutionmining.io/cdn/shop/t/1/assets/Elephants_Mesh_Grey.svg?v=143355747152055222861644598858" className="bg_collection" />
                            ...
                            {products.map(product => (
                                <li className="grid__item" key={product.id}>
                                    <div className="card-wrapper">
                                        <h3 className="card-information__text h4">{product.name}</h3>
                                        <div className="card-information">
                                            <div className="card-information__wrapper">
                                                <div className="product-form__input product-form__input--dropdown">
                                                    <label className="form__label" htmlFor={`Option-${product.id}-0`}>Hosted in</label>
                                                    <ul className="option">
                                                        <li className="active-option" data-host={product.location}></li>
                                                    </ul>
                                                    <div className="select">
                                                        <select id={`Option-${product.id}-0`} className="select__select" name={`options[Hosted in]`} form={`product-form-${product.id}`}>
                                                            <option value={product.location} selected="selected">{product.location}</option>
                                                        </select>
                                                ...
                                                <div className="price">
                                                    <div>
                                                        <div className="price__regular">
                                                            <span className="visually-hidden1 visually-hidden--inline">Price:</span>
                                                        ...
                                                        <div className="price__sale">
                                                            ...
                                                            <span className="price-item price-item--sale price-item--last">${product.price}</span>
                                                        </div>
                                                    </div>
                                                </div>
