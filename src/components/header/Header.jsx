  ...
  return (
    <div>
      <div
        ...
        style={{ backgroundColor: "rgb(9 7 19)" }}
      ...
      >
        ...
        <sticky-header className="header-wrapper color-background-1 gradient header-wrapper--border-bottom">
          <header className="header header--middle-left page-width header--has-menu">
                    ...
                    <div className="menu-drawer__navigation-container">
                      <nav className="menu-drawer__navigation">
                        <ul className="menu-drawer__menu list-menu" role="list">
                          ...
                          <li>
                            <Link
                              href="/blogs/the-revolution-blog"
                              className="menu-drawer__menu-item list-menu__item link link--text focus-inset"
                            >
                              Blog
                            </Link>
                      ...
                      <div className="menu-drawer__utility-links">
                        ...
                        >
                          <li className="list-social__item">
                            <Link
                              href="https://twitter.com/RevolMining"
                          ...
                          <li className="list-social__item">
                            <Link
                              href="https://www.facebook.com/RevolMining"
                              className="list-social__link link"
                            >
                              <svg
                                aria-hidden="true"
                          ...
                          <li className="list-social__item">
                            <Link
                              href="https://www.instagram.com/revolutionmining"
                              className="list-social__link link"
                            >
                              <svg
                                aria-hidden="true"
